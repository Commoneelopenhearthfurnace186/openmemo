...
CREATE OR REPLACE FUNCTION public.calendar_owner(t text)
RETURNS TABLE (timezone text, language text)
LANGUAGE plpgsql
SECURITY DEFINER
SET search_path = public
AS $$
...
BEGIN
  ...
  RETURN QUERY
  SELECT o.timezone, o.language FROM owner o WHERE o.id = 1;
END;
$$;
