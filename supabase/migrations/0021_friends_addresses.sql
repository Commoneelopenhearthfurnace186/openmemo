-- Friends and addresses: lightweight contacts and locations the agent
-- can store and retrieve. Includes optional birthday for friends so the
-- agent can search and remind on upcoming birthdays.
